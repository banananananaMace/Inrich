 ...
 */
void SX1280HalWriteCommand( RadioCommands_t opcode, uint8_t *buffer, uint16_t size,uint8_t  sxcase );
 ...
 */
void SX1280HalReadCommand( RadioCommands_t opcode, uint8_t *buffer, uint16_t size, uint8_t  sxcase);
