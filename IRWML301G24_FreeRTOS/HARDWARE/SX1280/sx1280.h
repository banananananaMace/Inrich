 ...
 */
void SX1280SetStandby( RadioStandbyModes_t mode,uint8_t  sxcase );
 ...
 */
void SX1280SetModulationParams( ModulationParams_t *modParams,uint8_t  sxcase);
 ...
 */
void SX1280GetRxBufferStatus( uint8_t *payloadLength, uint8_t *rxStartBuffer,uint8_t sxcase );
 ...
 */
void SX1280SetPayload( uint8_t *payload, uint8_t size,uint8_t  sxcase);
 ...
 */
uint8_t SX1280GetPayload( uint8_t *payload, uint8_t *size, uint8_t maxSize, uint8_t  sxcase  );
 ...
 *
 */
void SX1280SetCrcPolynomial( uint16_t seed,uint8_t  sxcase);
 ...
 */
void SX1280RangingSetFilterNumSamples( uint8_t numSample,uint8_t  sxcase );
...
extern  bool IrqState[6];
extern AppStates_t AppState[6];
